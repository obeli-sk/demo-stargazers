...
// Package execution represents the imported interface "obelisk:types/execution@3.0.0".
package execution
...
// JoinSet represents the imported resource "obelisk:types/execution@3.0.0#join-set".
//
// Join set resouce.
//
//	resource join-set
...
// ExecutionID represents the record "obelisk:types/execution@3.0.0#execution-id".
//
//	record execution-id {
//		id: string,
//	}
...
// DelayID represents the record "obelisk:types/execution@3.0.0#delay-id".
//
//	record delay-id {
//		id: string,
//	}
...
// Function represents the record "obelisk:types/execution@3.0.0#function".
//
//	record function {
...
// ResponseID represents the variant "obelisk:types/execution@3.0.0#response-id".
//
//	variant response-id {
...
// FunctionMismatch represents the record "obelisk:types/execution@3.0.0#function-mismatch".
//
...
// AwaitNextExtensionError represents the variant "obelisk:types/execution@3.0.0#await-next-extension-error".
//
...
// GetExtensionError represents the variant "obelisk:types/execution@3.0.0#get-extension-error".
//
...
// InvokeExtensionError represents the variant "obelisk:types/execution@3.0.0#invoke-extension-error".
//
...
// StubError represents the variant "obelisk:types/execution@3.0.0#stub-error".
//

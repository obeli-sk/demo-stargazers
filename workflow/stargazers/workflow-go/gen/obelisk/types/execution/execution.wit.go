...
// Package execution represents the imported interface "obelisk:types/execution@5.0.0".
package execution
...
// ExecutionID represents the record "obelisk:types/execution@5.0.0#execution-id".
//
//	record execution-id {
//		id: string,
//	}
...
// DelayID represents the record "obelisk:types/execution@5.0.0#delay-id".
//
//	record delay-id {
//		id: string,
//	}
...
// Function represents the record "obelisk:types/execution@5.0.0#function".
//
//	record function {
...
// ResponseID represents the variant "obelisk:types/execution@5.0.0#response-id".
//
//	variant response-id {
...
// FunctionMismatch represents the record "obelisk:types/execution@5.0.0#function-mismatch".
//
...
// ExecutionFailureKind represents the enum "obelisk:types/execution@5.0.0#execution-failure-kind".
//
...
var _ExecutionFailureKindStrings = [5]string{
	"timed-out",
	"nondeterminism-detected",
	"out-of-fuel",
	"cancelled",
...
// AwaitNextExtensionError represents the variant "obelisk:types/execution@5.0.0#await-next-extension-error".
//
...
// GetExtensionError represents the variant "obelisk:types/execution@5.0.0#get-extension-error".
//
...
// StubError represents the variant "obelisk:types/execution@5.0.0#stub-error".
//
...
// ScheduleJSONError represents the variant "obelisk:types/execution@5.0.0#schedule-json-error".
//

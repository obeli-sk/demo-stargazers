...
// Package time represents the imported interface "obelisk:types/time@4.2.0".
package time
...
// Duration represents the variant "obelisk:types/time@4.2.0#duration".
//
//	variant duration {
//		milliseconds(u64),
//		seconds(u64),
...
// DateTime represents the record "obelisk:types/time@4.2.0#datetime".
//
...
// ScheduleAt represents the variant "obelisk:types/time@4.2.0#schedule-at".
//
//	variant schedule-at {
//		now,
//		at(datetime),
